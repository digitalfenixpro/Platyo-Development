...
interface Translations {
  ...
  general: {
    visual_identity_title: string;
    logo_subtitle: string;
    no_logo: string;
    change_logo_button: string;
    upload_logo_button: string;
    delete_button: string;
    recommended_specs_title: string;
    accepted_formats_list: string;
    optimal_dimensions_list: string;
    max_size_list: string;
    prefer_transparent_bg_list: string;
    file_too_large_title: string;
    max_size_5mb_error: string;
    contact_location_subtitle: string;
    whatsapp_placeholder: string;
    required_for_whatsapp: string;
    address_placeholder: string;
    description_placeholder: string;
    max_500_chars_hint: string;
    language_currency_subtitle: string;
    language_selector_hint: string;
    language_es_option: string;
    language_en_option: string;
    currency_cop_option: string;
    currency_usd_option: string;
    currency_eur_option: string;
    currency_mxn_option: string;
    currency_ars_option: string;
    currency_clp_option: string;
    currency_pen_option: string;
    currency_selector_hint: string;
  };
  hours: {
    config_hours_subtitle: string;
    preparation_time_title: string;
    prep_time_label: string;
    prep_time_placeholder: string;
    prep_time_hint: string;
    opening_hours_section: string;
    hours_open_label: string;
    hours_close_label: string;
    important_info: string;
    hours_show_public: string;
    hours_show_status: string;
    hours_different_days: string;
  };
  social: {
    social_media_subtitle: string;
    facebook_placeholder: string;
    instagram_placeholder: string;
    twitter_placeholder: string;
    tiktok_placeholder: string;
    website_label: string;
    website_placeholder: string;
    about_social_media: string;
    social_footer_hint: string;
    social_full_urls: string;
    social_whatsapp_format: string;
    social_auto_icons: string;
  };
  delivery: {
    delivery_rates_title: string;
    rate_name_label: string;
  };
  billing: {
    commercial_name_placeholder: string;
    social_reason_placeholder: string;
    nit_placeholder: string;
  };
  support: {
...
const translations: Record<Language, Translations> = {
  es: {
    ...
    restaurantSettings: {
      ...
      general: {
        visual_identity_title: 'Identidad Visual',
        logo_subtitle: 'Logotipo y marca del restaurante',
        no_logo: 'Sin Logo',
        change_logo_button: 'Cambiar Logo',
        upload_logo_button: 'Subir Logo',
        delete_button: 'Eliminar',
        recommended_specs_title: 'Especificaciones Recomendadas',
        accepted_formats_list: 'Formatos: PNG, JPG, WebP',
        optimal_dimensions_list: 'Dimensiones óptimas: 500x500px',
        max_size_list: 'Tamaño máximo: 5MB',
        prefer_transparent_bg_list: 'Preferible con fondo transparente',
        file_too_large_title: 'Archivo muy grande',
        max_size_5mb_error: 'El tamaño máximo es 5MB',
        contact_location_subtitle: 'Datos de contacto y ubicación',
        whatsapp_placeholder: '+57 300 123 4567',
        required_for_whatsapp: 'Requerido para pedidos por WhatsApp',
        address_placeholder: 'Calle 123 #45-67, Bogotá',
        description_placeholder: 'Describe tu restaurante, especialidades, ambiente...',
        max_500_chars_hint: 'Máximo 500 caracteres',
        language_currency_subtitle: 'Idioma y moneda del menú',
        language_selector_hint: 'Idioma de la interfaz del menú público',
        language_es_option: 'Español',
        language_en_option: 'English',
        currency_cop_option: 'COP - Peso Colombiano',
        currency_usd_option: 'USD - Dólar Americano',
        currency_eur_option: 'EUR - Euro',
        ...
        currency_selector_hint: 'Moneda en la que se mostrarán los precios',
      },
      hours: {
        config_hours_subtitle: 'Configura los horarios de atención',
        preparation_time_title: 'Tiempo de Preparación',
        prep_time_label: 'Tiempo de preparación estimado',
        prep_time_placeholder: 'Ej: 30-45 minutos',
        prep_time_hint: 'Este tiempo se mostrará a los clientes al hacer pedidos',
        opening_hours_section: 'Horarios de Apertura',
        hours_open_label: 'Abre',
        hours_close_label: 'Cierra',
        important_info: 'Información importante',
        hours_show_public: 'Los horarios se mostrarán en tu menú público',
        hours_show_status: 'Se mostrará si estás abierto o cerrado actualmente',
        hours_different_days: 'Puedes configurar diferentes horarios para cada día',
      },
      social: {
        social_media_subtitle: 'Configura tus perfiles en redes sociales',
        facebook_placeholder: 'https://facebook.com/turestaurante',
        instagram_placeholder: 'https://instagram.com/turestaurante',
        twitter_placeholder: 'https://twitter.com/turestaurante',
        tiktok_placeholder: 'https://tiktok.com/@turestaurante',
        website_label: 'Sitio Web',
        website_placeholder: 'https://turestaurante.com',
        about_social_media: 'Acerca de las redes sociales',
        social_footer_hint: 'Estos enlaces aparecerán en el pie de página de tu menú',
        social_full_urls: 'Ingresa la URL completa de cada red social',
        social_whatsapp_format: 'Para WhatsApp usa formato internacional: +573001234567',
        social_auto_icons: 'Los iconos se mostrarán automáticamente según la URL',
      },
      delivery: {
      ...
      billing: {
        commercial_name_placeholder: 'Nombre de tu restaurante',
        social_reason_placeholder: 'Nombre legal de la empresa (opcional)',
        nit_placeholder: '123456789-0',
      },
      support: {
  ...
  en: {
    ...
    restaurantSettings: {
      ...
      general: {
        visual_identity_title: 'Visual Identity',
        logo_subtitle: 'Restaurant logo and branding',
        no_logo: 'No Logo',
        change_logo_button: 'Change Logo',
        upload_logo_button: 'Upload Logo',
        delete_button: 'Delete',
        recommended_specs_title: 'Recommended Specifications',
        accepted_formats_list: 'Formats: PNG, JPG, WebP',
        optimal_dimensions_list: 'Optimal dimensions: 500x500px',
        max_size_list: 'Maximum size: 5MB',
        prefer_transparent_bg_list: 'Transparent background preferred',
        file_too_large_title: 'File too large',
        max_size_5mb_error: 'Maximum size is 5MB',
        contact_location_subtitle: 'Contact details and location',
        whatsapp_placeholder: '+1 555 123 4567',
        required_for_whatsapp: 'Required for WhatsApp orders',
        address_placeholder: '123 Main Street, New York',
        description_placeholder: 'Describe your restaurant, specialties, atmosphere...',
        max_500_chars_hint: 'Maximum 500 characters',
        language_currency_subtitle: 'Menu language and currency',
        language_selector_hint: 'Public menu interface language',
        language_es_option: 'Spanish',
        language_en_option: 'English',
        currency_cop_option: 'COP - Colombian Peso',
        currency_usd_option: 'USD - US Dollar',
        currency_eur_option: 'EUR - Euro',
        ...
        currency_selector_hint: 'Currency for displaying prices',
      },
      hours: {
        config_hours_subtitle: 'Configure business hours',
        preparation_time_title: 'Preparation Time',
        prep_time_label: 'Estimated preparation time',
        prep_time_placeholder: 'e.g., 30-45 minutes',
        prep_time_hint: 'This time will be shown to customers when ordering',
        opening_hours_section: 'Opening Hours',
        hours_open_label: 'Opens',
        hours_close_label: 'Closes',
        important_info: 'Important information',
        hours_show_public: 'Hours will be displayed on your public menu',
        hours_show_status: 'Current open/closed status will be shown',
        hours_different_days: 'You can set different hours for each day',
      },
      social: {
        social_media_subtitle: 'Configure your social media profiles',
        facebook_placeholder: 'https://facebook.com/yourrestaurant',
        instagram_placeholder: 'https://instagram.com/yourrestaurant',
        twitter_placeholder: 'https://twitter.com/yourrestaurant',
        tiktok_placeholder: 'https://tiktok.com/@yourrestaurant',
        website_label: 'Website',
        website_placeholder: 'https://yourrestaurant.com',
        about_social_media: 'About social media',
        social_footer_hint: 'These links will appear in your menu footer',
        social_full_urls: 'Enter the full URL for each social network',
        social_whatsapp_format: 'For WhatsApp use international format: +15551234567',
        social_auto_icons: 'Icons will display automatically based on URL',
      },
      delivery: {
        delivery_rates_title: 'Delivery Rates',
        rate_name_label: 'Rate name',
      ...
      billing: {
        commercial_name_placeholder: 'Your restaurant name',
        social_reason_placeholder: 'Legal company name (optional)',
        nit_placeholder: '123456789-0',
      },
      support: {
