...
const translations: Record<Language, Translations> = {
  es: {
    ...
    tutorialStep3Item11: 'En la pestaña "Delivery", configura si ofreces servicio a domicilio:',
    tutorialStep3Item12: '• Activa el switch "Habilitar Delivery"',
    ...
    tutorialStep3Detail5: 'La configuración de delivery permite establecer diferentes costos según el monto del pedido',
    tutorialStep3Detail6: 'Si desactivas el delivery, los clientes solo podrán elegir "Recoger en tienda" o "Mesa"',
    tutorialStep3Detail7: 'Prueba diferentes combinaciones de colores para que coincidan con tu marca',
    tutorialStep3Image: 'Panel de Configuración mostrando pestañas: General, Personalización y Delivery con formularios para cada sección',
    ...
    tutorialStep4Item16: '• Por tipo (Delivery, Pickup, Mesa)',
    ...
    tutorialStep4Detail4: 'En los detalles del pedido verás: información del cliente, dirección (si es delivery), lista de productos con variaciones e ingredientes extras, notas especiales del cliente',
    ...
    tutorialStep5Item14: '• Finalizar la compra eligiendo: Recoger en tienda, Delivery, o Mesa',
    ...
    tutorialStep6Item11: '• Filtra por tipo de pedido (Delivery, Pickup, Mesa)',
